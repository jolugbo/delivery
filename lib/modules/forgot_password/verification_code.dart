...
import 'package:gt_delivery/modules/forgot_password/set_new_password.dart';
...
class ForgotPasswordVerificationCode extends StatefulWidget {
  ...
  static const String routeName = '/forgotPasswordVerificationCode';
  const ForgotPasswordVerificationCode(
      {super.key, required this.emailOrPhone, required this.channel});

  @override
  State<ForgotPasswordVerificationCode> createState() =>
                  ...
                  TextSpan(
                      ...
                      recognizer: TapGestureRecognizer()
                        ..onTap = () async {
                          ...
                          var response =
                              await authProvider.requestPasswordResetToken(
                    ...
                    onTap: () {
                      if (pin.length != 6) {
                        CustomSnackbar.showError(
                            context, "Please provide a valid Pin.");
                        return;
                      }
                      print("${widget.emailOrPhone},${widget.channel},$pin,");
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => SetNewPassword(
                                    accountTYpe: "Customer",
                                    emailOrPhone: widget.emailOrPhone,channel: widget.channel,
                                    pin: pin,
                                  )));
                    }
                    ),
